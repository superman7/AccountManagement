...
import com.digitalchina.xa.it.service.impl.MnemonicServiceImpl;
...
//	}
	public static void main(String[] args) {
		MnemonicServiceImpl ss = new MnemonicServiceImpl();
		String menmonic = ss.chooseMnemonic();
		System.out.println("助记词:" + menmonic);
		String pwd = "test";
		List<String> mnemonicList = ss.lockMnemonicByPwd(menmonic, pwd);
		String result = ss.merkleTreeRoot(mnemonicList);
